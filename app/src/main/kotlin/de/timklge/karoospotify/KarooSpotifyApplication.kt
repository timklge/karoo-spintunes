...
import de.timklge.karoospotify.auth.HttpException
import de.timklge.karoospotify.auth.OAuth2Client
import de.timklge.karoospotify.datatypes.PlayerDataType
import de.timklge.karoospotify.screens.SpotifySettings
    ...
    init {
        karooSystemService.connect { connected ->
            if (connected) {
                ...
                // Keep bluetooth on so that reaction time on player interaction is faster
